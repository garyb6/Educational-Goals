    ...
    return (
        ...
        <Router>
            <Routes>
                ...
                <Route path="/game" element={<GameContainer playerOne={playerOne} playerTwo={playerTwo} setPlayerOne={setPlayerOne} setPlayerTwo={setPlayerTwo} questionNumber={questionNumber} />} />
            </Routes>
        </Router>
